...
THEME = '/var/web/vd4393/deploy/current/theme/pelican-bootstrap3-edited/'
...
PLUGIN_PATHS = ["plugins", "/var/web/vd4393/deploy/current//plugins"]
...
#Photos plugin#
PHOTO_LIBRARY = "/var/web/vd4393/deploy/current//content/photos/"
