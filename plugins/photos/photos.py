    ...
    def replacer(m):
        ...
        if what == 'photo':
            ...
            if not os.path.isfile(path):
                ...
                origin = os.path.join(settings['SITEURL'], 'posts', 'photos', photo)
                enqueue_resize(
                    path,
                    os.path.join('posts', 'photos', photo),
...
def process_gallery(generator, content, location):
    ...
    for gallery in galleries:
        ...
        if os.path.isdir(dir_gallery):
            ...
            dir_photo = os.path.join('posts', 'photos', rel_gallery.lower())
            dir_thumb = os.path.join('posts', 'photos', rel_gallery.lower())
...
def process_image(generator, content, image):
    ...
    if os.path.isfile(path):
        ...
        content.photo_image = (
            ...
            os.path.join('posts', 'photos', photo),
            os.path.join('posts', 'photos', thumb))
        enqueue_resize(
            path,
            os.path.join('posts', 'photos', photo),
